...
/**
 * DTO (Data Transfer Object) for handling Recruiter Registration requests.
 * It captures the necessary information required to register a recruiter account.
 */
public class RecruiterRegistrationDto {
    ...
    private long phoneNo;               // Contact number of the recruiter
    ...
    /**
     * Parameterized constructor to initialize all fields of RecruiterRegistrationDto.
     *
     ...
     */
    public RecruiterRegistrationDto(String firstName, String lastName, String email,
                                    long phoneNo, String password, String confirmPassword) {
        super();
