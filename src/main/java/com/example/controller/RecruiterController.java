...
/**
 * REST Controller for managing recruiter-related operations such as registration, login, and profile update.
 */
@RestController
...
public class RecruiterController {
    ...
    public ResponseEntity<?> loginRecruiter(@RequestBody RecruiterLoginDto loginDto) {
        Recruiter recruiter = recruiterService.login(loginDto.getEmail(), loginDto.getPassword());
    ...
    public ResponseEntity<String> updateRecruiterProfile(
            @PathVariable int id,
